...
# docs. This file should be a Windows icon file (.ico) being 16x16 or 32x32 pixels
# large.
# html_favicon = None
...
latex_documents = [
    (
        "index",
        "govcookiecutter.tex",
        u"govcookiecutter Documentation",
        u"Government Digital Service",
        "manual",
    ),
]
...
texinfo_documents = [
    (
        ...
        u"Government Digital Service",
        "govcookiecutter",
        "A cookiecutter template for data science projects within UK public sector.",
        "Miscellaneous",
    ),
]
