# Code of conduct for `test_govcookiecutter`
...
- "Project", we mean this `test_govcookiecutter` GitHub repository;
...
[samuel.awonusi@ext.ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:samuel.awonusi@ext.ons.gov.uk
